...
$select="select * from b_info where dn='$uid'";
...
<form method="post" action="update_php.php" onSubmit="return Validate()" name="vForm">
		<table width="600" border="0" cellpadding="3"> 
      <tr>
        <td colspan="2"><p style="font-size: 24px">You Can Update Your Profile</p></td>
        </tr>
      <tr>
        <td width="300">NAME</td>
			<td><input type="text" name="username" class="textInput" placeholder="Username" value="<?php echo $username; ?>">
			<div id="name_error" class="val_error"></div>
		</td></tr>
		<tr>
        <td>E MAIL</td>
			<td><input type="email" name="email" class="textInput" placeholder="Email" value="<?php echo $email; ?>">
			<div id="email_error" class="val_error"></div>
		</td></tr>
		<tr>
        <td>PASSWORD</td>
			<td><input type="password" name="password" class="textInput" placeholder="Password" value="<?php echo $password; ?>">
		</td></tr>
		 <tr>
        <td>CONFORM PASSWORD</td>
			<td><input type="password" name="password_confirmation" class="textInput" placeholder="password confirmation" value="<?php echo $password; ?>">
  ...
  <option><?php echo $department; ?></option>
    ...
    <option>MCA III Year</option>
		 ...
		 <tr>
		   <td>MOBILE</td>
		   <td><input type="text" name="mobile" class="textInput" placeholder="mobile" value="<?php echo $mobile; ?>">
			<div id="mobile_error" class="val_error"></div></td>
	      </tr>
		<tr>
        <td>&nbsp;</td>
        <td>
			<input type="submit" class="btn" name="register" value="Update">
		</td></tr></table>
	</form>
    <form action="del_user.php" method="post">  <input name="" type="submit" value="Delete Account"/> </form>
